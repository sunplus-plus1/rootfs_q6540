...
enum vx_kernel_e {
    ...
    */
    ...
    VX_KERNEL_NN_INSTANCE_NORMALIZATION_SP_SPLIT_LAYER0 = VX_KERNEL_BASE(VX_ID_VIVANTE, VX_LIBRARY_KHR_BASE) + 0x46,
    VX_KERNEL_NN_INSTANCE_NORMALIZATION_SP_SPLIT_LAYER1 = VX_KERNEL_BASE(VX_ID_VIVANTE, VX_LIBRARY_KHR_BASE) + 0x47,
    VX_KERNEL_NN_INSTANCE_NORMALIZATION_SP_SPLIT_LAYER2 = VX_KERNEL_BASE(VX_ID_VIVANTE, VX_LIBRARY_KHR_BASE) + 0x48,
    ...
    VX_KERNEL_NN_LOGSOFTMAX_LAYER = VX_KERNEL_BASE(VX_ID_VIVANTE, VX_LIBRARY_KHR_BASE) + 0x54,

    VX_KERNEL_NN_RMS_NORM_LAYER = VX_KERNEL_BASE(VX_ID_VIVANTE, VX_LIBRARY_KHR_BASE) + 0x55,
