...
VX_API_ENTRY vx_weights_biases_parameter VX_API_CALL
vxCreateWeightsBiasesParameterFromTensorsEx(
    vx_graph graph,
    vx_enum layer_type,
    vx_size num_of_dims,
    vx_size * inputs_dims,
...
VX_API_ENTRY vx_weights_biases_parameter VX_API_CALL vxCreateWeightsBiasesParameterFromTensors2Ex(
    vx_graph    graph,
    vx_enum     layer_type,
    vx_size     num_of_dims,
    vx_size   * inputs_dims,
...
VX_API_ENTRY vx_weights_biases_parameter VX_API_CALL vxCreateWeightsBiasesParameterFromTensors3Ex(
    vx_graph    graph,
    vx_enum     layer_type,
    vx_size   * inputs_dims,
    vx_size   * convolution_outputs_dims,
...
VX_API_ENTRY vx_weights_biases_parameter VX_API_CALL
vxCreateWeightsBiasesParameterEx(
    vx_context context,
    vx_graph graph,
    vx_enum layer_type,
    vx_size num_of_dims,
