...
enum vx_type_e {
    ...
    */
    ...
    VX_TYPE_DEVICE          = 0x820,/*!< \brief A <tt>\ref vx_device</tt>. */
    VX_TYPE_ENV             = 0x821,/*!< \brief A <tt>\ref a value for env setting </tt>. */
};
...
enum vx_tensor_attribute_e
{
    ...
    VX_TENSOR_MEMORY_ATTRIBUTE = VX_ATTRIBUTE_BASE(VX_ID_VIVANTE, VX_TYPE_TENSOR) + 0x8, /*query DAM attribute*/
    VX_TENSOR_MEMORY_POOL_TYPE = VX_ATTRIBUTE_BASE(VX_ID_VIVANTE, VX_TYPE_TENSOR) + 0x9,
};
