...
ifeq ($(BR2_PACKAGE_SWUPDATE_HW_COMPATIBILITY),y)
define SWUPDATE_SET_HW_COMPATIBILITY
	$(call KCONFIG_ENABLE_OPT,CONFIG_HW_COMPATIBILITY)
endef
else
define SWUPDATE_SET_HW_COMPATIBILITY
	$(call KCONFIG_DISABLE_OPT,CONFIG_HW_COMPATIBILITY)
endef
endif

ifeq ($(BR2_PACKAGE_SWUPDATE_SSL_IMPL_NONE),y)
define SWUPDATE_SET_SSL_IMPL
	$(call KCONFIG_ENABLE_OPT,CONFIG_SSL_IMPL_NONE)
endef
else ifeq ($(BR2_PACKAGE_SWUPDATE_SSL_IMPL_OPENSSL),y)
define SWUPDATE_SET_SSL_IMPL
	$(call KCONFIG_ENABLE_OPT,CONFIG_SSL_IMPL_OPENSSL)
endef
else ifeq ($(BR2_PACKAGE_SWUPDATE_SSL_IMPL_WOLFSSL),y)
define SWUPDATE_SET_SSL_IMPL
	$(call KCONFIG_ENABLE_OPT,CONFIG_SSL_IMPL_WOLFSSL)
endef
else ifeq ($(BR2_PACKAGE_SWUPDATE_SSL_IMPL_MBEDTLS),y)
define SWUPDATE_SET_SSL_IMPL
	$(call KCONFIG_ENABLE_OPT,CONFIG_SSL_IMPL_MBEDTLS)
endef
endif

ifeq ($(BR2_PACKAGE_SWUPDATE_HASH_VERIFY),y)
define SWUPDATE_SET_HASH_VERIFY
	$(call KCONFIG_ENABLE_OPT,CONFIG_HASH_VERIFY)
endef
else
define SWUPDATE_SET_HASH_VERIFY
	$(call KCONFIG_DISABLE_OPT,CONFIG_HASH_VERIFY)
endef
endif

ifeq ($(BR2_PACKAGE_SWUPDATE_SIGNED_IMAGES),y)
define SWUPDATE_SET_SIGNED_IMAGES
	$(call KCONFIG_ENABLE_OPT,CONFIG_SIGNED_IMAGES)
endef
else
define SWUPDATE_SET_SIGNED_IMAGES
	$(call KCONFIG_DISABLE_OPT,CONFIG_SIGNED_IMAGES)
endef
endif

ifeq ($(BR2_PACKAGE_SWUPDATE_SIGALG_RAWRSA),y)
define SWUPDATE_SET_SIGALG
	$(call KCONFIG_ENABLE_OPT,CONFIG_SIGALG_RAWRSA)
endef
else ifeq ($(BR2_PACKAGE_SWUPDATE_SIGALG_RSAPSS),y)
define SWUPDATE_SET_SIGALG
	$(call KCONFIG_ENABLE_OPT,CONFIG_SIGALG_RSAPSS)
endef
else ifeq ($(BR2_PACKAGE_SWUPDATE_SIGALG_CMS),y)
define SWUPDATE_SET_SIGALG
	$(call KCONFIG_ENABLE_OPT,CONFIG_SIGALG_CMS)
endef
else ifeq ($(BR2_PACKAGE_SWUPDATE_SIGALG_GPG),y)
define SWUPDATE_SET_SIGALG
	$(call KCONFIG_ENABLE_OPT,CONFIG_SIGALG_GPG)
endef
endif

ifeq ($(BR2_PACKAGE_SWUPDATE_CMS_IGNORE_EXPIRED_CERTIFICATE),y)
define SWUPDATE_CMS
	$(call KCONFIG_ENABLE_OPT,CONFIG_SIGALG_RAWRSA)
endef
else ifeq ($(BR2_PACKAGE_SWUPDATE_CMS_IGNORE_CERTIFICATE_PURPOSE),y)
define SWUPDATE_CMS
	$(call KCONFIG_ENABLE_OPT,CONFIG_SIGALG_RSAPSS)
endef
else ifeq ($(BR2_PACKAGE_SWUPDATE_CMS_SKIP_UNKNOWN_SIGNERS),y)
define SWUPDATE_CMS
	$(call KCONFIG_ENABLE_OPT,CONFIG_SIGALG_CMS)
endef
else
define SWUPDATE_CMS
	$(call KCONFIG_DISABLE_OPT,CONFIG_SIGALG_CMS)
endef
endif
...
define SWUPDATE_KCONFIG_FIXUP_CMDS
	...
	$(SWUPDATE_SET_HW_COMPATIBILITY)
	$(SWUPDATE_SET_SSL_IMPL)
	$(SWUPDATE_SET_HASH_VERIFY)
	$(SWUPDATE_SET_SIGNED_IMAGES)
	$(SWUPDATE_SET_SIGALG)
	$(SWUPDATE_SET_CMS)
endef
